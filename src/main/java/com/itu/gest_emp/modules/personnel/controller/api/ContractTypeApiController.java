...
public class ContractTypeApiController {
    ...
    public ResponseEntity<ContractType> getContractTypeByCode(@PathVariable("code") String code) {
        Optional<ContractType> contractTypeData = contractTypeService.getContractTypeByCode(code);
        return contractTypeData.map(contractType -> new ResponseEntity<>(contractType, HttpStatus.OK))
                .orElseGet(() -> new ResponseEntity<>(HttpStatus.NOT_FOUND));
    }
    ...
    public ResponseEntity<ContractType> createContractType(@RequestBody ContractType contractType) {
        try {
            ...
            if (contractTypeService.existsByCode(contractType.getCode())) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ContractType> updateContractType(@PathVariable("id") Long id,
